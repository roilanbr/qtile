...
from mymodule.theme import fcThemeColor # Escoger el tema
...
# Asignar variables para el tema escogido: 
# high(Fuerte), half(Medio), light(Ligero), low(Bajo)
theme = "half"
(colorBg, colorCl, colorComment, colorFg,
 colorRed, colorOrange, colorYellow, colorGreen,
 colorCyan, colorPurple, colorPink) = fcThemeColor(theme)

# variables de colores
colorBg = colorBg           # "#282a36" Background
colorCl = colorCl           # "#f8f8f2" Foreground
colorComment = colorComment # "#44475a" Current Line
colorFg = colorFg           # "#6272a4" Comment
colorRed = colorRed         # "#ff5555" Red
colorOrange = colorOrange   # "#ffb86c" Orange
colorYellow = colorYellow   # "#f1fa8c" Yellow
colorGreen = colorGreen     # "#50fa7b" Green
colorCyan = colorCyan       # "#8be9fd" Cyan
colorPurple = colorPurple   # "#bd93f9" Purple
colorPink = colorPink       # "#ff79c6" Pink
...
def fcPuntasWidget(colorBgIcon, colorFgIcon, direccion):
    if direccion == 0:   # Si es 0
    ...
    return widget.TextBox(
        ...
        foreground = colorFgIcon, # Color texto
...
keys = [
    ...
    Key([mod], "m", lazy.spawn("rofi -show drun"), desc="Lanzador"),
    ...
    Screen(
        ...
        bottom=bar.Bar(
            [
                ...
                # WIDGET GRUPO 3 ================
                # Icon Volumen, Fecha y hora y Notificaciones
                # fcPuntasWidget(colorBg, colorRed, 0), # Punta
                widget.Volume(
